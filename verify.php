...
if ($success === true)
{
   ...
   if (mysqli_num_rows($check_cart) > 0) {
        ...
        $insert_order = mysqli_query($conn, "INSERT INTO db.orders(user_id, name,phone_no, email, transaction_id, address, total_products, total_price) VALUES('$user_id', '$name', '$number', '$email', '$transaction_id', '$address', '$total_products', '$total_price')");
        ...
        $insert_order_items = mysqli_query($conn,"INSERT INTO db.order_items(`order_id`,`pid`, `product_name`, `product_price`, `quantity`) VALUES ('$Oid','$Ppid', '$Pname', '$Pprice', '$Pqty')");
