...
if(isset($_GET['delivery_status'])){
   ...
   $select_orders = mysqli_query($conn, "SELECT * FROM db.orders WHERE delivery_status = '$d_status' order by id desc");
}
else{
...
if(isset($_GET['user_id'])){
   ...
   $select_orders = mysqli_query($conn, "SELECT * FROM db.orders WHERE user_id = '$user_id' order by id desc");
}
      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <p> Number : <span><?= $list['phone_no']; ?></span> </p>
