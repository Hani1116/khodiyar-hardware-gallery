   ...
   <section class="checkout-orders">
      ...
      <form action="pay.php" method="POST">
         ...
         <div class="flex">
            <div class="inputBox">
               <span>Your name :</span>
               <input type="text" name="name" placeholder="Enter your name"  value="<?= $user_data['name'] ?>" class="box border" maxlength="20" required>
            </div>
            <div class="inputBox">
               <span>Mobile number :</span>
               <input type="text" id="contact_number" placeholder="Enter your contact number" name="number" value="<?= $user_data['phone_no'] ?>" class="box border"  onkeypress="if(this.value.length == 10) return false;" required>
            </div>
            <div class="inputBox">
               <span>Your email :</span>
               <input type="email" id="email" name="email" placeholder="Enter your email" value="<?= $user_data['email'] ?>" class="box border" maxlength="50" required>
            </div>
            
            <div class="inputBox">
               <span>Address line 01 :</span>
               <input type="text" name="flat" placeholder="e.g. Flat number" class="box border" maxlength="50" required>
            </div>
            <div class="inputBox">
               <span>Address line 02 :</span>
               <input type="text" name="street" placeholder="e.g. Street name" class="box border" maxlength="50" required>
            </div>
            <div class="inputBox">
               <span>Area :</span>
               <input type="text" name="city" placeholder="e.g. Nikol" class="box border" maxlength="50" required>
            </div>
            <div class="inputBox">
               <span>Pin code :</span>
               <input type="text" min="0" name="pin_code" placeholder="e.g. 123456" value="<?php if(isset($pic_code)){ echo $pic_code ;} ?>" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box border" required>
            </div>
         </div>

         <input type="submit" id="submit_button" name="order" class="btn <?= ($grand_total > 1) ? '' : 'disabled'; ?>" value="place order">
